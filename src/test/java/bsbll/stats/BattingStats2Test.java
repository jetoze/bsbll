...
public final class BattingStats2Test {
    private static final BattingStats2 willieMays1955 = BattingStats2.builder()
            .set(GAMES, 152)
    ...
    public void ctorRejectsNegativeValues() {
        new BattingStats2(ImmutableMap.of(GAMES, 1, PLATE_APPEARANCES, -4));
    }
    
    @Test
    public void testAdd() {
        BattingStats2 willieMays1956 = BattingStats2.builder()
                .set(GAMES, 152)
                ...
                .build();
        BattingStats2 total = willieMays1955.add(willieMays1956);
        
        BattingStats2 expected = BattingStats2.builder()
                .set(GAMES, 304)
